...
public class SocketIOManager : MonoBehaviour
{
    ...
    private void OnInitReceived(string jsonData)
    {
        ...
        try
        {
            ...
            var initialMatrix = GenerateRandomMatrix(gameConfig.reelCount, gameConfig.rowCount);
    ...
    #endregion
    private List<List<int>> GenerateRandomMatrix(int reelCount, int rowCount)
    {
        ...
        for (int col = 0; col < reelCount; col++)
        {
            ...
            {
                column.Add(UnityEngine.Random.Range(0, 9));
            }
            matrix.Add(column);
        }
        return matrix;
